...
#define MAKE_ERROR(code, desc) { code, { #code, desc } }
            ...
            std::pair<char const* const, char const* const>> const results
    {
        ...
        MAKE_ERROR(tecNO_SUITABLE_PAGE,       "A suitable page could not be located."),
        MAKE_ERROR(tecBUY_SELL_MISMATCH,      "The 'Buy' and 'Sell' offers are mismatched."),
        MAKE_ERROR(tecOFFER_TYPE_MISMATCH,    "The type of offer is incorrect."),
        MAKE_ERROR(tecCANT_ACCEPT_OWN_OFFER,  "An offer cannot be claimed by its owner."),
        ...
        MAKE_ERROR(tecINCORRECT_ASSET,        "The asset used for payment is not accepted."),
        MAKE_ERROR(tecTOO_MANY,               "Too many items were specified."),
        ...
        MAKE_ERROR(tefNOT_POSSIBLE,              "The requested operation is not possible."),
        MAKE_ERROR(tefTOKEN_IS_NOT_TRANSFERABLE, "The specified token is not transferable."),
        ...
        MAKE_ERROR(temBAD_TRANSFER_FEE,          "Malformed: The transfer fee must be between 1 and 5000, inclusive."),
        MAKE_ERROR(temTOKEN_IS_NONFLAMMABLE,     "Malformed: The specified token cannot be burned."),
